...
_DEPS=ujson-dump.h ujson-array.h ujson-value.h ujson-types.h ujson-string.h ujson-hash.h ujson-encode.h ujson-extract.h ujson-data.h ujson-parse.h hexdump.h endian.h udp.h schematags.h ujsizes.h movebytes.h
IDIR=inc
DEPS=$(pasubst %,$(IDIR)/%,$(_DEPS))

# List of source files, excluding the EXE and TESTS runnables above
_SOURCES=ujson-dump.c ujson-array.c ujson-value.c ujson-string.c ujson-hash.c ujson-encode.c ujson-extract.c ujson-data.c ujson-parse.c hexdump.c udp.c endian.c movebytes.c
SDIR=src
